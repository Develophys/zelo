    ...
    <div className="px-4">
      <div className={`${CHAT_COLUMN} relative`}>
        <Button
          ...
          className="absolute -top-7 right-0 z-10 flex h-7 w-14 items-end justify-center rounded-t-card border border-b-0 border-surface-brand bg-canvas-alt pb-1 text-muted hover:text-brand after:absolute after:inset-x-0 after:-top-2 after:-bottom-2 after:content-['']"
        >
