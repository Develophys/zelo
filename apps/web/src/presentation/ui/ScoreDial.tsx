  ...
  return (
    <div className="text-center">
      ...
      <div aria-hidden="true">
        ...
        <span className={`text-score-max ${tone.max}`}>/{max}</span>
        <div className="mt-3">
          <span
