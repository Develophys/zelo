...
export const FIELD_SURFACE =
  'w-full rounded-pill border border-line bg-surface p-[13px_18px] text-[16px] text-ink placeholder:text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand';
