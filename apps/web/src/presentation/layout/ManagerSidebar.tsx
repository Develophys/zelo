...
export function ManagerSidebar({ className = '' }: ManagerSidebarProps) {
  ...
  return (
    <aside
      ...
      className={[
        'hidden flex-none flex-col border-r border-surface-brand md:sticky md:top-app-header md:flex md:h-[calc(100dvh-var(--spacing-app-header))] md:w-19 motion-safe:transition-[width] motion-safe:duration-150',
        collapsed ? '' : 'lg:w-55',
        className,
      ]
        .filter(Boolean)
