...
export type ClosingTic = "rhetorical_reframe";

export function classifyClosingTic(sentence: string): ClosingTic | null {
  return RHETORICAL_REFRAME.test(sentence.trim()) ? "rhetorical_reframe" : null;
}
